...
read_when:
  - You want AlphaClaw to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables AlphaClaw to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`alphaclaw onboard`) and `alphaclaw channels add` list optional channel plugins.
...
```bash
alphaclaw plugins install @alphaclaw/nostr
```

Use a local checkout (dev workflows):

```bash
alphaclaw plugins install --link <path-to-alphaclaw>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "alphaclaw",
        "displayName": "AlphaClaw",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "alphaclaw@example.com",
        "lud16": "alphaclaw@example.com"
      }
    }
  }
}
