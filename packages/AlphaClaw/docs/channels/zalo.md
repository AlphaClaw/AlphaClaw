...
- Install via CLI: `alphaclaw plugins install @alphaclaw/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `alphaclaw plugins install ./extensions/zalo`
   - From npm (if published): `alphaclaw plugins install @alphaclaw/zalo`
...
- Approve via:
  - `alphaclaw pairing list zalo`
  - `alphaclaw pairing approve zalo <CODE>`
...
- Example: `alphaclaw message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `alphaclaw channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `alphaclaw logs --follow`
