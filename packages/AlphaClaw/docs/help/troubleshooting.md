...
### `docs.alphaclaw.ai` shows an SSL error (Comcast/Xfinity)

Some Comcast/Xfinity connections block `docs.alphaclaw.ai` via Xfinity Advanced Security.
Disable Advanced Security or add `docs.alphaclaw.ai` to the allowlist, then retry.
...
- Check the allowlist: `alphaclaw config get agents.defaults.models`
...
If you can, include the relevant log tail from `alphaclaw logs --follow`.
