...
AlphaClaw treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.alphaclaw/settings/voicewake.json`

Shape:

```json
{ "triggers": ["alphaclaw", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
