...
Deepgram is a speech-to-text API. In AlphaClaw it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, AlphaClaw uploads the audio file to Deepgram and injects the transcript
