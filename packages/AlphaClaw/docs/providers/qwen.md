---
summary: "Use Qwen OAuth (free tier) in AlphaClaw"
read_when:
  - You want to use Qwen with AlphaClaw
...
If you already logged in with the Qwen Code CLI, AlphaClaw will sync credentials
