---
summary: "Use Synthetic's Anthropic-compatible API in AlphaClaw"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. AlphaClaw registers it as the
...
Note: AlphaClaw's Anthropic client appends `/v1` to the base URL, so use
