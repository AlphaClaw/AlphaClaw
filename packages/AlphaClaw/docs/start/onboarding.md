---
summary: "First-run onboarding flow for AlphaClaw (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give AlphaClaw">
...
<Step title="CLI">
  ...
  The app can install the global `alphaclaw` CLI via npm/pnpm so terminal
