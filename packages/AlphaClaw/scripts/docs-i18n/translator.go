...
func NewPiTranslator(srcLang, tgtLang string, glossary []GlossaryEntry, thinking string) (*PiTranslator, error) {
	...
	options.AppName = "alphaclaw-docs-i18n"
	options.WorkDir = "/tmp"
...
- Keep product names in English: AlphaClaw, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the AlphaClaw Gateway, use “Gateway 网关”.
