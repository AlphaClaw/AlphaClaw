...
docker run --rm -t \
  ...
  -e ALPHACLAW_LIVE_MODELS="${ALPHACLAW_LIVE_MODELS:-${ALPHACLAW_LIVE_MODELS:-all}}" \
  -e ALPHACLAW_LIVE_PROVIDERS="${ALPHACLAW_LIVE_PROVIDERS:-${ALPHACLAW_LIVE_PROVIDERS:-}}" \
  -e ALPHACLAW_LIVE_MODEL_TIMEOUT_MS="${ALPHACLAW_LIVE_MODEL_TIMEOUT_MS:-${ALPHACLAW_LIVE_MODEL_TIMEOUT_MS:-}}" \
  -e ALPHACLAW_LIVE_REQUIRE_PROFILE_KEYS="${ALPHACLAW_LIVE_REQUIRE_PROFILE_KEYS:-${ALPHACLAW_LIVE_REQUIRE_PROFILE_KEYS:-}}" \
