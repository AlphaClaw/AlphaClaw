...
function resolveAvatarSource(cfg: AlphaClawConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: AlphaClawConfig, agentId: string): AgentAvatarResolution {
