...
describe("Agent-specific tool filtering", () => {
    ...
    const cfg: AlphaClawConfig = {
      ...
      agents: {
        list: [
          {
            id: "restricted",
            workspace: "~/alphaclaw-restricted",
            tools: {
  ...
  it("should allow different tool policies for different agents", () => {
    ...
    const mainTools = createAlphaClawCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
    ...
    const familyTools = createAlphaClawCodingTools({
      config: cfg,
  ...
  it("should apply group tool policy overrides (group-specific beats wildcard)", () => {
    ...
    const trustedTools = createAlphaClawCodingTools({
      config: cfg,
  ...
  it("should apply per-sender tool policies for group tools", () => {
    ...
    const aliceTools = createAlphaClawCodingTools({
      config: cfg,
    ...
    const bobTools = createAlphaClawCodingTools({
      config: cfg,
      sessionKey: "agent:main:whatsapp:group:family",
      senderId: "bob",
  ...
  it("should not let default sender policy override group tools", () => {
    ...
    const adminTools = createAlphaClawCodingTools({
      config: cfg,
