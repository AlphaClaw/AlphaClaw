...
describe("createAlphaClawCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createAlphaClawCodingTools({
      config,
    ...
    const anthropicTools = createAlphaClawCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createAlphaClawCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createAlphaClawCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
