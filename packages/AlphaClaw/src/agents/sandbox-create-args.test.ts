  ...
  it("includes hardening and resource flags", () => {
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        ...
        "alphaclaw.sandbox=1",
        "--label",
        "alphaclaw.sessionKey=main",
        "--label",
        "alphaclaw.createdAtMs=1700000000000",
        "--label",
        "alphaclaw.sandboxBrowser=1",
        "--read-only",
        "--tmpfs",
        "/tmp",
        "--network",
