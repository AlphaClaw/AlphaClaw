...
function resolveWatchPaths(workspaceDir: string, config?: AlphaClawConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: AlphaClawConfig }) {
