...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@alphaclaw", { botUsername: "alphaclaw" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@alphaclaw args", {
        botUsername: "alphaclaw",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@alphaclaw: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "alphaclaw" })).toBe(
      "/help@otherbot",
    );
  });
