...
function resolveMentionPatterns(cfg: AlphaClawConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: AlphaClawConfig | undefined, agentId?: string): RegExp[] {
