...
export type ChannelAgentToolFactory = (params: { cfg?: AlphaClawConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: AlphaClawConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: AlphaClawConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: AlphaClawConfig }) => boolean;
  supportsCards?: (params: { cfg: AlphaClawConfig }) => boolean;
