...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "alphaclaw-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<AlphaClawConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<AlphaClawConfig["telegram"]>>,
