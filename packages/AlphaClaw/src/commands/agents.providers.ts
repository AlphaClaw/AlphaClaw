...
function resolveDefaultAccountId(cfg: AlphaClawConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: AlphaClawConfig): boolean {
...
export function summarizeBindings(cfg: AlphaClawConfig, bindings: AgentBinding[]): string[] {
