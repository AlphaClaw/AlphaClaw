...
const ensureAlphaClawModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveAlphaClawAgentDir = vi.fn().mockReturnValue("/tmp/alphaclaw-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/alphaclaw-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureAlphaClawModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveAlphaClawAgentDir,
}));
