...
export function applyZaiConfig(cfg: AlphaClawConfig): AlphaClawConfig {
...
export function applyOpenrouterProviderConfig(cfg: AlphaClawConfig): AlphaClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: AlphaClawConfig): AlphaClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: AlphaClawConfig): AlphaClawConfig {
...
export function applyOpenrouterConfig(cfg: AlphaClawConfig): AlphaClawConfig {
...
export function applyMoonshotProviderConfig(cfg: AlphaClawConfig): AlphaClawConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: AlphaClawConfig): AlphaClawConfig {
...
export function applyMoonshotConfig(cfg: AlphaClawConfig): AlphaClawConfig {
...
export function applyMoonshotConfigCn(cfg: AlphaClawConfig): AlphaClawConfig {
...
export function applyKimiCodeProviderConfig(cfg: AlphaClawConfig): AlphaClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: AlphaClawConfig): AlphaClawConfig {
...
export function applySyntheticProviderConfig(cfg: AlphaClawConfig): AlphaClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: AlphaClawConfig): AlphaClawConfig {
...
export function applyXiaomiProviderConfig(cfg: AlphaClawConfig): AlphaClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: AlphaClawConfig): AlphaClawConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: AlphaClawConfig): AlphaClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: AlphaClawConfig): AlphaClawConfig {
...
export function applyXaiProviderConfig(cfg: AlphaClawConfig): AlphaClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: AlphaClawConfig): AlphaClawConfig {
