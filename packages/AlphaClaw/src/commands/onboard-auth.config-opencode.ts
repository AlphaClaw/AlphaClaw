...
export function applyOpencodeZenProviderConfig(cfg: AlphaClawConfig): AlphaClawConfig {
...
export function applyOpencodeZenConfig(cfg: AlphaClawConfig): AlphaClawConfig {
