...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.alphaclaw.ai/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("alphaclaw hooks list")}`,
      `  ${formatCliCommand("alphaclaw hooks enable <name>")}`,
      `  ${formatCliCommand("alphaclaw hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
