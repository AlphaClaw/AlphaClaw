...
import { type AlphaClawConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: AlphaClawConfig): string[] {
...
export function listAgentsForGateway(cfg: AlphaClawConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: AlphaClawConfig): string {
...
function resolveSessionStoreAgentId(cfg: AlphaClawConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: AlphaClawConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: AlphaClawConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: AlphaClawConfig): GatewaySessionsDefaults {
