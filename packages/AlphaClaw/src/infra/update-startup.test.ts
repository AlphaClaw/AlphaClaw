...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "alphaclaw-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveAlphaClawPackageRoot } = await import("./alphaclaw-root.js");
    ...
    vi.mocked(resolveAlphaClawPackageRoot).mockResolvedValue("/opt/alphaclaw");
