...
export function listSignalAccountIds(cfg: AlphaClawConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: AlphaClawConfig): string {
...
function mergeSignalAccountConfig(cfg: AlphaClawConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: AlphaClawConfig): ResolvedSignalAccount[] {
