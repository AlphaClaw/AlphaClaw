...
import type { GatewayBindMode, GatewayTailscaleMode, AlphaClawConfig } from "../config/config.js";
...
export async function configureGatewayForOnboarding(
  ...
  if (tailscaleMode !== "off" && flow !== "quickstart") {
    await prompter.note(
      ["Docs:", "https://docs.alphaclaw.ai/gateway/tailscale", "https://docs.alphaclaw.ai/web"].join(
        "\n",
      ),
      "Tailscale",
    );
