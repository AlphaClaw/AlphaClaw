...
AlphaClaw has two separate “streaming” layers:
...
When block streaming is enabled, AlphaClaw can **merge consecutive block chunks**
...
When draft streaming is active, AlphaClaw disables block streaming for that reply to avoid double-streaming.
