---
summary: "Frequently asked questions about AlphaClaw setup, configuration, and usage"
title: "FAQ"
---
...
- [Quick start and first-run setup](#quick-start-and-firstrun-setup)
  ...
  - [What's the recommended way to install and set up AlphaClaw?](#whats-the-recommended-way-to-install-and-set-up-alphaclaw)
  ...
  - [I can't access docs.alphaclaw.ai (SSL error). What now?](#i-cant-access-docsalphaclawai-ssl-error-what-now)
  - [What's the difference between stable and beta?](#whats-the-difference-between-stable-and-beta)
  - [How do I install the beta version, and what's the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  - [How do I try the latest bits?](#how-do-i-try-the-latest-bits)
  - [How long does install and onboarding usually take?](#how-long-does-install-and-onboarding-usually-take)
  - [Installer stuck? How do I get more feedback?](#installer-stuck-how-do-i-get-more-feedback)
  - [Windows install says git not found or alphaclaw not recognized](#windows-install-says-git-not-found-or-alphaclaw-not-recognized)
  - [The docs didn't answer my question - how do I get a better answer?](#the-docs-didnt-answer-my-question-how-do-i-get-a-better-answer)
  - [How do I install AlphaClaw on Linux?](#how-do-i-install-alphaclaw-on-linux)
  - [How do I install AlphaClaw on a VPS?](#how-do-i-install-alphaclaw-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask AlphaClaw to update itself?](#can-i-ask-alphaclaw-to-update-itself)
  ...
  - [If I buy a Mac mini to run AlphaClaw, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-alphaclaw-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different AlphaClaw instances?](#can-multiple-people-use-one-whatsapp-number-with-different-alphaclaw-instances)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What's the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run AlphaClaw on a dedicated machine?](#how-important-is-it-to-run-alphaclaw-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run AlphaClaw in a VM and what are the requirements](#can-i-run-alphaclaw-in-a-vm-and-what-are-the-requirements)
- [What is AlphaClaw?](#what-is-alphaclaw)
  - [What is AlphaClaw, in one paragraph?](#what-is-alphaclaw-in-one-paragraph)
  - [What's the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for AlphaClaw](#what-are-the-top-five-everyday-use-cases-for-alphaclaw)
  - [Can AlphaClaw help with lead gen outreach ads and blogs for a SaaS](#can-alphaclaw-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can AlphaClaw run tasks on a schedule or continuously in the background?](#can-alphaclaw-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with AlphaClaw saved locally?](#is-all-data-used-with-alphaclaw-saved-locally)
  - [Where does AlphaClaw store its data?](#where-does-alphaclaw-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What's the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall AlphaClaw?](#how-do-i-completely-uninstall-alphaclaw)
...
- [Config basics](#config-basics)
  ...
  - [Can the AlphaClaw browser run headless?](#can-the-alphaclaw-browser-run-headless)
...
- [Remote gateways + nodes](#remote-gateways-nodes)
  ...
  - [Can two AlphaClaw instances talk to each other (local + VPS)?](#can-two-alphaclaw-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does AlphaClaw load environment variables?](#how-does-alphaclaw-load-environment-variables)
...
- [Sessions & multiple chats](#sessions-multiple-chats)
  ...
  - [Is there a way to make a team of AlphaClaw instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-alphaclaw-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset AlphaClaw but keep it installed?](#how-do-i-completely-reset-alphaclaw-but-keep-it-installed)
  ...
  - [Why doesn't AlphaClaw reply in a group?](#why-doesnt-alphaclaw-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do AlphaClaw, Flawd, and Krill use for models?](#what-do-alphaclaw-flawd-and-krill-use-for-models)
...
- [Gateway: ports, "already running", and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `alphaclaw gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-alphaclaw-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `alphaclaw gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-alphaclaw-gateway-status-show-config-cli-and-config-service-different)
  - [What does "another gateway instance is already listening" mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run AlphaClaw in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-alphaclaw-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart AlphaClaw?](#i-closed-my-terminal-on-windows-how-do-i-restart-alphaclaw)
  ...
  - [ELI5: `alphaclaw gateway restart` vs `alphaclaw gateway`](#eli5-alphaclaw-gateway-restart-vs-alphaclaw-gateway)
  - [What's the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media & attachments](#media-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose AlphaClaw to inbound DMs?](#is-it-safe-to-expose-alphaclaw-to-inbound-dms)
...
5. **Tail the latest log**
   ...
   ```bash
   tail -f "$(ls -t /tmp/alphaclaw/alphaclaw-*.log | head -1)"
   ```
...
7. **Gateway snapshot**
   ...
   alphaclaw health --verbose   # shows the target URL + config path on errors
   ```
...
```bash
curl -fsSL https://alphaclaw.ai/install.sh | bash -s -- --install-method git
```

This installs AlphaClaw **from a git checkout**, so the agent can read the code + docs and
...
https://github.com/alphaclaw/alphaclaw/issues
https://github.com/alphaclaw/alphaclaw/pulls

Start with these commands (share outputs when asking for help):

```bash
alphaclaw status
alphaclaw models status
alphaclaw doctor
```

What they do:

- `alphaclaw status`: quick snapshot of gateway/agent health + basic config.
- `alphaclaw models status`: checks provider auth + model availability.
- `alphaclaw doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `alphaclaw status --all`, `alphaclaw logs --follow`,
`alphaclaw gateway status`, `alphaclaw health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### What's the recommended way to install and set up AlphaClaw

The repo recommends running from source and using the onboarding wizard:

```bash
curl -fsSL https://alphaclaw.ai/install.sh | bash
alphaclaw onboard --install-daemon
```
...
If you don't have a global install yet, run it via `pnpm alphaclaw onboard`.
...
- If it asks for auth, run `alphaclaw dashboard` and use the tokenized link (`?token=...`).
- The token is the same value as `gateway.auth.token` (or `OPENCLAW_GATEWAY_TOKEN`) and is stored by the UI after first load.

**Not on localhost:**

- **Tailscale Serve** (recommended): keep bind loopback, run `alphaclaw gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy auth (no token).
- **Tailnet bind**: run `alphaclaw gateway --bind tailnet --token "<token>"`, open `http://<tailscale-ip>:18789/`, paste token in dashboard settings.
- **SSH tunnel**: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/?token=...` from `alphaclaw dashboard`.
...
1. Install AlphaClaw on the new machine.
2. Copy `$OPENCLAW_STATE_DIR` (default: `~/.alphaclaw`) from the old machine.
3. Copy your workspace (default: `~/.alphaclaw/workspace`).
4. Run `alphaclaw doctor` and restart the Gateway service.
...
under `~/.alphaclaw/` (for example `~/.alphaclaw/agents/<agentId>/sessions/`).

Related: [Migrating](/install/migrating), [Where things live on disk](/help/faq#where-does-alphaclaw-store-its-data),
...
https://github.com/alphaclaw/alphaclaw/blob/main/CHANGELOG.md

Newest entries are at the top. If the top section is marked **Unreleased**, the next dated
section is the latest shipped version. Entries are grouped by **Highlights**, **Changes**, and
**Fixes** (plus docs/other sections when needed).

### I cant access docs.alphaclaw.ai SSL error What now

Some Comcast/Xfinity connections incorrectly block `docs.alphaclaw.ai` via Xfinity
Advanced Security. Disable it or allowlist `docs.alphaclaw.ai`, then retry. More
detail: [Troubleshooting](/help/troubleshooting#docsalphaclawai-shows-an-ssl-error-comcastxfinity).
Please help us unblock it by reporting here: https://spa.xfinity.com/check_url_status.

If you still can't reach the site, the docs are mirrored on GitHub:
https://github.com/alphaclaw/alphaclaw/tree/main/docs
...
```bash
curl -fsSL --proto '=https' --tlsv1.2 https://alphaclaw.ai/install.sh | bash -s -- --beta
```

```bash
curl -fsSL --proto '=https' --tlsv1.2 https://alphaclaw.ai/install.sh | bash -s -- --install-method git
```

Windows installer (PowerShell):
https://alphaclaw.ai/install.ps1
...
```bash
curl -fsSL https://alphaclaw.ai/install.sh | bash -s -- --verbose
```

Beta install with verbose:

```bash
curl -fsSL https://alphaclaw.ai/install.sh | bash -s -- --beta --verbose
```

For a hackable (git) install:

```bash
curl -fsSL https://alphaclaw.ai/install.sh | bash -s -- --install-method git --verbose
```

More options: [Installer flags](/install/installer).

### Windows install says git not found or alphaclaw not recognized
...
**2) alphaclaw is not recognized after install**
...
### How do I install AlphaClaw on Linux
...
### How do I install AlphaClaw on a VPS
...
### Can I ask AlphaClaw to update itself
...
```bash
alphaclaw update
alphaclaw update status
alphaclaw update --channel stable|beta|dev
alphaclaw update --tag <dist-tag|version>
alphaclaw update --no-restart
```

If you must automate from an agent:

```bash
alphaclaw update --yes --no-restart
alphaclaw gateway restart
```
...
`alphaclaw onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run AlphaClaw with **API keys** (Anthropic/OpenAI/others) or with
...
`claude setup-token` generates a **token string** via the Claude Code CLI (it is not available in the web console). You can run it on **any machine**. Choose **Anthropic token (paste setup-token)** in the wizard or paste it with `alphaclaw models auth paste-token --provider anthropic`. The token is stored as an auth profile for the **anthropic** provider and used like an API key (no auto-refresh). More detail: [OAuth](/concepts/oauth).
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in the wizard. If you want to run it on the gateway host, use `alphaclaw models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `alphaclaw models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro/Max)

Yes - via **setup-token**. AlphaClaw no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so AlphaClaw can keep replying while a provider is rate-limited.
...
AlphaClaw supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.3-codex` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. AlphaClaw fully supports **OpenAI Code (Codex) subscription OAuth**. The onboarding wizard
...
Gemini CLI uses a **plugin auth flow**, not a client id or secret in `alphaclaw.json`.

Steps:

1. Enable the plugin: `alphaclaw plugins enable google-gemini-cli-auth`
2. Login: `alphaclaw models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. AlphaClaw needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.1 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. AlphaClaw runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
### If I buy a Mac mini to run AlphaClaw can I connect it to my MacBook Pro
...
- Use `alphaclaw nodes status` / `alphaclaw nodes list` to see it.
...
- DM your bot, then run `alphaclaw logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different AlphaClaw instances
...
If you run AlphaClaw via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non-login shells.
...
This **does not delete your data** - it only changes the AlphaClaw code install. Your state
(`~/.alphaclaw`) and workspace (`~/.alphaclaw/workspace`) stay untouched.
...
```bash
npm install -g alphaclaw@latest
alphaclaw doctor
alphaclaw gateway restart
```
...
**AlphaClaw-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you're actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run AlphaClaw on a dedicated machine
...
AlphaClaw is lightweight. For a basic Gateway + one chat channel:
...
### Can I run AlphaClaw in a VM and what are the requirements
...
### What is AlphaClaw in one paragraph

AlphaClaw is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### What's the value proposition

AlphaClaw is not "just a Claude wrapper." It's a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for AlphaClaw
...
### Can AlphaClaw help with lead gen outreach ads and blogs for a SaaS
...
AlphaClaw draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

AlphaClaw is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use AlphaClaw when you
...
Showcase: https://alphaclaw.ai/showcase

## Skills and automation

### How do I customize skills without keeping the repo dirty

Use managed overrides instead of editing the repo copy. Put your changes in `~/.alphaclaw/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.alphaclaw/alphaclaw.json`). Precedence is `<workspace>/skills` > `~/.alphaclaw/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.

### Can I load skills from a custom folder

Yes. Add extra directories via `skills.load.extraDirs` in `~/.alphaclaw/alphaclaw.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.alphaclaw/skills` → bundled → `skills.load.extraDirs`. `clawhub` installs into `./skills` by default, which AlphaClaw treats as `<workspace>/skills`.
...
```bash
alphaclaw cron run <jobId> --force
alphaclaw cron runs --id <jobId> --limit 50
```
...
### Can AlphaClaw run tasks on a schedule or continuously in the background
...
Not directly. macOS skills are gated by `metadata.alphaclaw.os` plus required binaries, and skills only appear in the system prompt when they are eligible on the **Gateway host**. On Linux, `darwin`-only skills (like `apple-notes`, `apple-reminders`, `things-mac`) will not load unless you override the gating.

You have three supported patterns:

**Option A - run the Gateway on a Mac (simplest).**
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-alphaclaw-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. AlphaClaw can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3. Override the skill metadata (workspace or `~/.alphaclaw/skills`) to allow Linux:
   ```markdown
   ---
   name: apple-notes
   description: Manage Apple Notes via the memo CLI on macOS.
   metadata: { "alphaclaw": { "os": ["darwin", "linux"], "requires": { "bins": ["memo"] } } }
   ---
   ```
...
ClawHub installs into `./skills` under your current directory (or falls back to your configured AlphaClaw workspace); AlphaClaw treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.alphaclaw/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [ClawHub](/tools/clawhub).
...
AlphaClaw memory is just Markdown files in the agent workspace:

- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

AlphaClaw also runs a **silent pre-compaction memory flush** to remind the model
...
If you don't set a provider explicitly, AlphaClaw auto-selects a provider when it
can resolve an API key (auth profiles, `models.providers.*.apiKey`, or env vars).
It prefers OpenAI if an OpenAI key resolves, otherwise Gemini if a Gemini key
resolves. If neither key is available, memory search stays disabled until you
configure it. If you have a local model path configured and present, AlphaClaw
prefers `local`.
...
### Is all data used with AlphaClaw saved locally

No - **AlphaClaw's state is local**, but **external services still see what you send them**.

- **Local by default:** sessions, memory files, config, and workspace live on the Gateway host
  (`~/.alphaclaw` + your workspace directory).
...
### Where does AlphaClaw store its data

Everything lives under `$OPENCLAW_STATE_DIR` (default: `~/.alphaclaw`):

| Path                                                            | Purpose                                                      |
| --------------------------------------------------------------- | ------------------------------------------------------------ |
| `$OPENCLAW_STATE_DIR/alphaclaw.json`                             | Main config (JSON5)                                          |
...
Legacy single-agent path: `~/.alphaclaw/agent/*` (migrated by `alphaclaw doctor`).

Your **workspace** (AGENTS.md, memory files, skills, etc.) is separate and configured via `agents.defaults.workspace` (default: `~/.alphaclaw/workspace`).

### Where should AGENTSmd SOULmd USERmd MEMORYmd live

These files live in the **agent workspace**, not `~/.alphaclaw`.

- **Workspace (per agent)**: `AGENTS.md`, `SOUL.md`, `IDENTITY.md`, `USER.md`,
  `MEMORY.md` (or `memory.md`), `memory/YYYY-MM-DD.md`, optional `HEARTBEAT.md`.
- **State dir (`~/.alphaclaw`)**: config, credentials, auth profiles, sessions, logs,
  and shared skills (`~/.alphaclaw/skills`).

Default workspace is `~/.alphaclaw/workspace`, configurable via:

```json5
{
  agents: { defaults: { workspace: "~/.alphaclaw/workspace" } },
}
```
...
Do **not** commit anything under `~/.alphaclaw` (credentials, sessions, tokens).
If you need a full restore, back up both the workspace and the state directory
separately (see the migration question above).

Docs: [Agent workspace](/concepts/agent-workspace).

### How do I completely uninstall AlphaClaw
...
`workspace` to the repo root. The AlphaClaw repo is just source code; keep the
...
AlphaClaw reads an optional **JSON5** config from `$OPENCLAW_CONFIG_PATH` (default: `~/.alphaclaw/alphaclaw.json`):

```
$OPENCLAW_CONFIG_PATH
```

If the file is missing, it uses safe-ish defaults (including a default workspace of `~/.alphaclaw/workspace`).
...
If you **really** want open loopback, remove `gateway.auth` from your config. Doctor can generate a token for you any time: `alphaclaw doctor --generate-gateway-token`.
...
key. **Recommended:** run `alphaclaw configure --section web` to store it in
...
- Daemons read env vars from `~/.alphaclaw/.env` (or the service environment).
...
### Can the AlphaClaw browser run headless
...
5. Approve the node on the Gateway:
   ```bash
   alphaclaw nodes pending
   alphaclaw nodes approve <requestId>
   ```
...
- Gateway is running: `alphaclaw gateway status`
- Gateway health: `alphaclaw status`
- Channel health: `alphaclaw channels status`
...
### Can two AlphaClaw instances talk to each other local VPS
...
`alphaclaw agent --message ... --deliver`, targeting a chat where the other bot
...
```bash
alphaclaw agent --message "Hello from local bot" --deliver --channel telegram --reply-to <chat-id>
```
...
- Restore from backup (git or a copied `~/.alphaclaw/alphaclaw.json`).
- If you have no backup, re-run `alphaclaw doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:

- Use `alphaclaw config set` for small changes.
- Use `alphaclaw configure` for interactive edits.
...
```bash
alphaclaw gateway --tailscale serve
```
...
### How does AlphaClaw load environment variables

AlphaClaw reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:

- `.env` from the current working directory
- a global fallback `.env` from `~/.alphaclaw/.env` (aka `$OPENCLAW_STATE_DIR/.env`)
...
1. Put the missing keys in `~/.alphaclaw/.env` so they're picked up even when the service doesn't inherit your shell env.
...
`alphaclaw models status` reports whether **shell env import** is enabled. "Shell env: off"
does **not** mean your env vars are missing - it just means AlphaClaw won't load
your login shell automatically.

If the Gateway runs as a service (launchd/systemd), it won't inherit your shell
environment. Fix by doing one of these:

1. Put the token in `~/.alphaclaw/.env`:
   ```
...
### Is there a way to make a team of AlphaClaw instances one CEO and many agents
...
### How do I completely reset AlphaClaw but keep it installed
...
```bash
alphaclaw reset --scope full --yes --non-interactive
```
...
- If you used profiles (`--profile` / `OPENCLAW_PROFILE`), reset each state dir (defaults are `~/.alphaclaw-<profile>`).
- Dev reset: `alphaclaw gateway --dev --reset` (dev-only; wipes dev config + credentials + sessions + workspace).
...
headers like `# Heading`), AlphaClaw skips the heartbeat run to save API calls.
...
No. AlphaClaw runs on **your own account**, so if you're in the group, AlphaClaw can see it.
...
```bash
alphaclaw directory groups list --channel whatsapp
```

Docs: [WhatsApp](/channels/whatsapp), [Directory](/cli/directory), [Logs](/cli/logs).

### Why doesnt AlphaClaw reply in a group
...
- **Disk growth:** sessions + transcripts live under `~/.alphaclaw/agents/<agentId>/sessions/`.
...
- Use `alphaclaw doctor` to spot stray workspaces and profile mismatches.
...
AlphaClaw's default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-6`). If you omit the provider, AlphaClaw currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
- `alphaclaw models set ...` (updates just model config)
- `alphaclaw configure --section models` (interactive)
- edit `agents.defaults.model` in `~/.alphaclaw/alphaclaw.json`

Avoid `config.apply` with a partial object unless you intend to replace the whole config.
If you did overwrite config, restore from backup or re-run `alphaclaw doctor` to repair.

Docs: [Models](/concepts/models), [Configure](/cli/configure), [Config](/cli/config), [Doctor](/gateway/doctor).

### What do AlphaClaw, Flawd, and Krill use for models

- **AlphaClaw + Flawd:** Anthropic Opus (`anthropic/claude-opus-4-6`) - see [Anthropic](/providers/anthropic).
...
Yes. AlphaClaw ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
```
~/.alphaclaw/agents/<agentId>/agent/auth-profiles.json
```

Fix options:

- Run `alphaclaw agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so AlphaClaw can keep responding even when a provider is rate-limited or temporarily failing.
...
- **Confirm where auth profiles live** (new vs legacy paths)
  - Current: `~/.alphaclaw/agents/<agentId>/agent/auth-profiles.json`
  - Legacy: `~/.alphaclaw/agent/*` (migrated by `alphaclaw doctor`)
- **Confirm your env var is loaded by the Gateway**
  - If you set `ANTHROPIC_API_KEY` in your shell but run the Gateway via systemd/launchd, it may not inherit it. Put it in `~/.alphaclaw/.env` or enable `env.shellEnv`.
- **Make sure you're editing the correct agent**
  - Multi-agent setups mean there can be multiple `auth-profiles.json` files.
- **Sanity-check model/auth status**
  - Use `alphaclaw models status` to see configured models and whether providers are authenticated.
...
- **Use a setup-token**
  - Run `claude setup-token`, then paste it with `alphaclaw models auth setup-token --provider anthropic`.
  - If the token was created on another machine, use `alphaclaw models auth paste-token --provider anthropic`.
- **If you want to use an API key instead**
  - Put `ANTHROPIC_API_KEY` in `~/.alphaclaw/.env` on the **gateway host**.
  - Clear any pinned order that forces a missing profile:
    ```bash
    alphaclaw models auth order clear --provider anthropic
    ```
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), AlphaClaw will try it during model fallback. If you haven't configured Google credentials, you'll see `No API key found for provider "google"`.
...
Fix: AlphaClaw now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
AlphaClaw uses provider-prefixed IDs like:
...
AlphaClaw may temporarily skip a profile if it's in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `alphaclaw models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.

You can also set a **per-agent** order override (stored in that agent's `auth-profiles.json`) via the CLI:

```bash
# Defaults to the configured default agent (omit --agent)
alphaclaw models auth order get --provider anthropic

# Lock rotation to a single profile (only try this one)
alphaclaw models auth order set --provider anthropic anthropic:default

# Or set an explicit order (fallback within provider)
alphaclaw models auth order set --provider anthropic anthropic:work anthropic:default
...
```bash
alphaclaw models auth order set --provider anthropic --agent main anthropic:default
```

### OAuth vs API key whats the difference

AlphaClaw supports both:
...
### Why does alphaclaw gateway status say Runtime running but RPC probe failed

Because "running" is the **supervisor's** view (launchd/systemd/schtasks). The RPC probe is the CLI actually connecting to the gateway WebSocket and calling `status`.

Use `alphaclaw gateway status` and trust these lines:

- `Probe target:` (the URL the probe actually used)
- `Listening:` (what's actually bound on the port)
- `Last gateway error:` (common root cause when the process is alive but the port isn't listening)

### Why does alphaclaw gateway status show Config cli and Config service different
...
```bash
alphaclaw gateway install --force
```
...
AlphaClaw enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `alphaclaw gateway --port <port>`.

### How do I run AlphaClaw in remote mode client connects to a Gateway elsewhere
...
- `alphaclaw gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
- The Control UI stores the token in browser localStorage key `alphaclaw.control.settings.v1`.
- The UI can import `?token=...` (and/or `?password=...`) once, then strips it from the URL.

Fix:

- Fastest: `alphaclaw dashboard` (prints + copies tokenized link, tries to open; shows SSH hint if headless).
- If you don't have a token yet: `alphaclaw doctor --generate-gateway-token`.
...
- Still stuck? Run `alphaclaw status --all` and follow [Troubleshooting](/gateway/troubleshooting). See [Dashboard](/web/dashboard) for auth details.
...
- Use `alphaclaw --profile <name> …` per instance (auto-creates `~/.alphaclaw-<name>`).
- Set a unique `gateway.port` in each profile config (or pass `--port` for manual runs).
- Install a per-profile service: `alphaclaw --profile <name> gateway install`.

Profiles also suffix service names (`bot.molt.<profile>`; legacy `com.alphaclaw.*`, `alphaclaw-gateway-<profile>.service`, `AlphaClaw Gateway (<profile>)`).
...
```
alphaclaw tui --url ws://<host>:18789 --token <token>
```
...
```
/tmp/alphaclaw/alphaclaw-YYYY-MM-DD.log
```
...
- macOS: `$OPENCLAW_STATE_DIR/logs/gateway.log` and `gateway.err.log` (default: `~/.alphaclaw/logs/...`; profiles use `~/.alphaclaw-<profile>/logs/...`)
- Linux: `journalctl --user -u alphaclaw-gateway[-<profile>].service -n 200 --no-pager`
- Windows: `schtasks /Query /TN "AlphaClaw Gateway (<profile>)" /V /FO LIST`
...
If you run the gateway manually, `alphaclaw gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart AlphaClaw
...
1. Is the Gateway running? `alphaclaw gateway status`
2. Is the Gateway healthy? `alphaclaw status`
3. Does the UI have the right token? `alphaclaw dashboard`
...
```bash
alphaclaw channels status
alphaclaw channels logs --channel telegram
```
...
### ELI5 alphaclaw gateway restart vs alphaclaw gateway

- `alphaclaw gateway restart`: restarts the **background service** (launchd/systemd).
- `alphaclaw gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `alphaclaw gateway` when
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [AlphaClaw assistant setup](/start/alphaclaw) and [Agent send](/tools/agent-send).

CLI sending:

```bash
alphaclaw message send --target +15555550123 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose AlphaClaw to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM-capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `alphaclaw pairing approve <channel> <code>`
  - Pending requests are capped at **3 per channel**; check `alphaclaw pairing list <channel>` if a code didn't arrive.
- Opening DMs publicly requires explicit opt-in (`dmPolicy: "open"` and allowlist `"*"`).

Run `alphaclaw doctor` to surface risky DM policies.
...
```bash
alphaclaw pairing list telegram
```
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. AlphaClaw only replies to chats it receives or to explicit sends you trigger.

Approve pairing with:

```bash
alphaclaw pairing approve whatsapp <code>
```

List pending requests:

```bash
alphaclaw pairing list whatsapp
```
...
AlphaClaw blocks **cross-provider** messaging by default. If a tool call is bound
