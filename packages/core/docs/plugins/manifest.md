...
read_when:
  - You are building a AlphaClaw plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (alphaclaw.plugin.json)

Every plugin **must** ship a `alphaclaw.plugin.json` file in the **plugin root**.
AlphaClaw uses this manifest to validate configuration **without executing plugin
