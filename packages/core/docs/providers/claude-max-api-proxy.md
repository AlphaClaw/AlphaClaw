...
You can point AlphaClaw at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or AlphaClaw
...
- [Anthropic provider](/providers/anthropic) - Native AlphaClaw integration with Claude setup-token or API keys
