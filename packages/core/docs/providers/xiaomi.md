---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with AlphaClaw"
read_when:
  - You want Xiaomi MiMo models in AlphaClaw
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). AlphaClaw uses
