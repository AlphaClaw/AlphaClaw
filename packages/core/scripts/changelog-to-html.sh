...
if [[ -z "$version_content" ]]; then
  echo "<h2>AlphaClaw $VERSION</h2>"
  echo "<p>Latest AlphaClaw update.</p>"
  echo "<p><a href=\"https://github.com/alphaclaw/alphaclaw/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
