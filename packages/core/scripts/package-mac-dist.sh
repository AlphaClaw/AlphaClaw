...
# Output:
# - dist/AlphaClaw.app
# - dist/AlphaClaw-<version>.zip
# - dist/AlphaClaw-<version>.dmg
...
APP="$ROOT_DIR/dist/AlphaClaw.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/AlphaClaw-$VERSION.zip"
DMG="$ROOT_DIR/dist/AlphaClaw-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/AlphaClaw-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/AlphaClaw-$VERSION.dSYM.zip"
