...
export const DEFAULT_SANDBOX_WORKSPACE_ROOT = path.join(os.homedir(), ".alphaclaw", "sandboxes");

export const DEFAULT_SANDBOX_IMAGE = "alphaclaw-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "alphaclaw-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "alphaclaw-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "alphaclaw-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "alphaclaw-sbx-browser-";
...
const resolvedSandboxStateDir = STATE_DIR ?? path.join(os.homedir(), ".alphaclaw");
