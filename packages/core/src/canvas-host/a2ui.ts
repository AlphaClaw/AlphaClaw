...
export const A2UI_PATH = "/__alphaclaw__/a2ui";

export const CANVAS_HOST_PATH = "/__alphaclaw__/canvas";

export const CANVAS_WS_PATH = "/__alphaclaw__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.alphaclawCanvasA2UIAction.postMessage(...)
  // - Android: window.alphaclawCanvasA2UIAction.postMessage(...)
  const handlerNames = ["alphaclawCanvasA2UIAction"];
  ...
  globalThis.AlphaClaw = globalThis.AlphaClaw ?? {};
  globalThis.AlphaClaw.postMessage = postToNode;
  globalThis.AlphaClaw.sendUserAction = sendUserAction;
  globalThis.alphaclawPostMessage = postToNode;
  globalThis.alphaclawSendUserAction = sendUserAction;
