...
const SANDBOX_EXAMPLES = {
  main: [
    ["alphaclaw sandbox list", "List all sandbox containers."],
    ["alphaclaw sandbox list --browser", "List only browser containers."],
    ["alphaclaw sandbox recreate --all", "Recreate all containers."],
    ["alphaclaw sandbox recreate --session main", "Recreate a specific session."],
    ["alphaclaw sandbox recreate --agent mybot", "Recreate agent containers."],
    ["alphaclaw sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["alphaclaw sandbox list", "List all sandbox containers."],
    ["alphaclaw sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["alphaclaw sandbox recreate --all", "Recreate all containers."],
    ["alphaclaw sandbox recreate --session main", "Recreate a specific session."],
    ["alphaclaw sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["alphaclaw sandbox recreate --browser --all", "Recreate only browser containers."],
    ["alphaclaw sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["alphaclaw sandbox explain", "Show effective sandbox config."],
    ["alphaclaw sandbox explain --session agent:main:main", "Explain a specific session."],
    ["alphaclaw sandbox explain --agent work", "Explain an agent sandbox."],
    ["alphaclaw sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.alphaclaw.ai/cli/sandbox")}\n`,
    )
    .action(() => {
