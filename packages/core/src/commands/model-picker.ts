...
function resolveConfiguredModelRaw(cfg: AlphaClawConfig): string {
...
function resolveConfiguredModelKeys(cfg: AlphaClawConfig): string[] {
...
export function applyPrimaryModel(cfg: AlphaClawConfig, model: string): AlphaClawConfig {
...
export function applyModelAllowlist(cfg: AlphaClawConfig, models: string[]): AlphaClawConfig {
  const defaults = cfg.agents?.defaults;
