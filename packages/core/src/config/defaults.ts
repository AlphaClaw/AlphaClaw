...
function resolveAnthropicDefaultAuthMode(cfg: AlphaClawConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: AlphaClawConfig): AlphaClawConfig {
...
export function applyTalkApiKey(config: AlphaClawConfig): AlphaClawConfig {
...
export function applyModelDefaults(cfg: AlphaClawConfig): AlphaClawConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: AlphaClawConfig): AlphaClawConfig {
...
export function applyLoggingDefaults(cfg: AlphaClawConfig): AlphaClawConfig {
...
export function applyContextPruningDefaults(cfg: AlphaClawConfig): AlphaClawConfig {
...
export function applyCompactionDefaults(cfg: AlphaClawConfig): AlphaClawConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
