...
function mergeFeishuAccountConfig(cfg: AlphaClawConfig, accountId: string): FeishuAccountConfig {
...
export function listFeishuAccountIds(cfg: AlphaClawConfig): string[] {
...
export function resolveDefaultFeishuAccountId(cfg: AlphaClawConfig): string {
