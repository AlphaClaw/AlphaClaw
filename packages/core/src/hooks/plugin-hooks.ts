...
import type { AlphaClawPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: AlphaClawPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: AlphaClawPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
