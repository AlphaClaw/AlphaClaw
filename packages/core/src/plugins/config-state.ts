...
export const normalizePluginsConfig = (
  config?: AlphaClawConfig["plugins"],
...
const hasExplicitMemorySlot = (plugins?: AlphaClawConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: AlphaClawConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.prototype.hasOwnProperty.call(plugins.entries, "memory-core"));

const hasExplicitPluginConfig = (plugins?: AlphaClawConfig["plugins"]) => {
  if (!plugins) {
    return false;
  }
