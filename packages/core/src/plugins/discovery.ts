...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @alphaclaw/voice-call -> voice-call).
...
export function discoverAlphaClawPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".alphaclaw", "extensions")];
