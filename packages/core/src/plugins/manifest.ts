...
export const PLUGIN_MANIFEST_FILENAME = "alphaclaw.plugin.json";
...
// package.json "alphaclaw" metadata (used for onboarding/catalog)
...
export type AlphaClawPackageManifest = {
  extensions?: string[];
...
): AlphaClawPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
