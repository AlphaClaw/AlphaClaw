...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof AlphaClawConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: AlphaClawConfig; env: NodeJS.ProcessEnv }): {
  cfg: AlphaClawConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
