...
function listConfiguredAccountIds(cfg: AlphaClawConfig): string[] {
...
export function listWhatsAppAuthDirs(cfg: AlphaClawConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: AlphaClawConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: AlphaClawConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: AlphaClawConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: AlphaClawConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: AlphaClawConfig): ResolvedWhatsAppAccount[] {
