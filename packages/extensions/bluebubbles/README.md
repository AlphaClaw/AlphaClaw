...
This directory contains the **BlueBubbles external channel plugin** for AlphaClaw.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `alphaclaw/plugin-sdk` helpers.
