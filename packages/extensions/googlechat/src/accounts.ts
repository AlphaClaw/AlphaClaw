...
export function listGoogleChatAccountIds(cfg: AlphaClawConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: AlphaClawConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: AlphaClawConfig): ResolvedGoogleChatAccount[] {
