...
export type MatrixMonitorHandlerParams = {
  ...
  core: {
    ...
    channel: (typeof import("alphaclaw/plugin-sdk"))["channel"];
    system: {
      enqueueSystemEvent: (
        text: string,
  ...
  mentionRegexes: ReturnType<
    (typeof import("alphaclaw/plugin-sdk"))["channel"]["mentions"]["buildMentionRegexes"]
  >;
              ...
              if (created) {
                ...
                try {
                  await sendMessageMatrix(
                    `room:${roomId}`,
                    [
                      "AlphaClaw: access not configured.",
                      "",
                      `Pairing code: ${code}`,
                      "",
