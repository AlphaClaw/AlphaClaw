...
export function listMattermostAccountIds(cfg: AlphaClawConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: AlphaClawConfig): string {
...
export function listEnabledMattermostAccounts(cfg: AlphaClawConfig): ResolvedMattermostAccount[] {
