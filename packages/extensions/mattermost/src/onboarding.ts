import type { ChannelOnboardingAdapter, AlphaClawConfig, WizardPrompter } from "alphaclaw/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.alphaclaw.ai/channels/mattermost",
    ].join("\n"),
