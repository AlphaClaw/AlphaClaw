...
Nostr DM channel plugin for AlphaClaw using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to AlphaClaw. It enables your bot to:
...
# Configure alphaclaw to use local relay
