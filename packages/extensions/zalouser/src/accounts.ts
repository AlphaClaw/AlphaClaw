...
export function listZalouserAccountIds(cfg: AlphaClawConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: AlphaClawConfig): string {
...
function mergeZalouserAccountConfig(cfg: AlphaClawConfig, accountId: string): ZalouserAccountConfig {
